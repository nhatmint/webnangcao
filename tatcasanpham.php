    ...
    <div class="body_middle">
        ...
        <div class="sonmoi" id="one">
            ...
            <?php
	                ...
	                $product_array = $db_handle->runQuery("SELECT * FROM  sanpham WHERE LoaiHang = 'sonmoi' ");
            ...
            <?php
                	require_once("dbcontroller.php");
                    $db_handle = new DBController();
	                $product_array = $db_handle->runQuery("SELECT * FROM  sanpham WHERE LoaiHang = 'kemmat' ");
	                if (!empty($product_array)) { 
                        foreach($product_array as $key=>$value){
                            ?>
                            <div class="one" >
            ...
            <?php
                	require_once("dbcontroller.php");
                    $db_handle = new DBController();
	                $product_array = $db_handle->runQuery("SELECT * FROM  sanpham WHERE LoaiHang = 'danhmat' ");
	                if (!empty($product_array)) { 
                        foreach($product_array as $key=>$value){
                            ?>
                            <div class="one" >
            ...
            <?php
                	require_once("dbcontroller.php");
                    $db_handle = new DBController();
	                $product_array = $db_handle->runQuery("SELECT * FROM  sanpham WHERE LoaiHang = 'phukien' ");
	                if (!empty($product_array)) { 
                        foreach($product_array as $key=>$value){
                            ?>
                            <div class="one" >
